...
abstract class BaseFacebook
{
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if (curl_errno($ch) == 60 || stripos(curl_error($ch), 'error setting certificate verify locations') !== false || stripos(curl_error($ch), 'SSL certificate problem') !== false) { // CURLE_SSL_CACERT
