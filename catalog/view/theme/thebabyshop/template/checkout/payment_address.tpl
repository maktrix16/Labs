        ...
        <?php } else { ?>
            <?php if ($addresses) { ?>
                ...
                <div id="payment-existing">
                    <select name="address_id" style="width: 100%; margin-bottom: 15px;" size="1">
...
<br />
<div class="buttons">
  <div class="left"><input type="checkbox" id="changeshippingbox" name="changeshipping" vlaue="T" checked="checked"><?php echo $text_checkout_changeshipping;?></div>
  <div class="right">
