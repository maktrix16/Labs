...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/thebabyshop/stylesheet/onecheckout.css" media="screen" />
<style type="text/css">
...
<?php if (!$logged) { ?> 
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-address .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
			$('.wait').remove();
		},
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#shipping-method .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
			$('.wait').remove();
		},
...
function registerorguest(){
  ...
  if($('#payment-address input[name=\'account\']:checked').attr('value')){
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-address .onecheckout-content').append('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
			$('.wait').remove();
		},
...
function shippingaddress(){
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#shipping-address .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
			$('.wait').remove();
		},
...
function paymentmethod(countryid, zoneid, isset, city, postcode) {
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-method .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
			$('.wait').remove();
		},
...
$('#button-login').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-login').after('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-coupon').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-coupon').after('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#button-reward').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-reward').after('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#button-voucher').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-voucher').after('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#confirmorder #button-confirm').live('click', function() {
	...
	$('#confirmorder #button-confirm').after('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
});
  ...
  $('.warning').fadeIn('slow');	
	...
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-confirmorder').after('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
		},		
		success: function(json) {
			$('.success, .warning').remove();	
...
function getzone(atype,zoneid){
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#'+atype+'-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/thebabyshop/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},			
