...
<?php if($this->config->get('thebabyshop_homepage_latest_status')== 0) { ?> 
...
<?php if($this->config->get('thebabyshop_homepage_latest_status')== 1) { ?>
<div id="carousel-latest-<?php echo $module; ?>" class="es-carousel-wrapper">
...
<script type="text/javascript">
	...
	$('#carousel-latest-<?php echo $module; ?>').elastislide({
