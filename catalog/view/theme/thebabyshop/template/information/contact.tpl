...
<?php if($this->config->get('thebabyshop_contact_custom_status')== 1) { ?> 
<?php if ($thebabyshop_contact_custom_content) { ?>  
<div class="contact-custom">
    <?php echo htmlspecialchars_decode($thebabyshop_contact_custom_content); ?>        
</div>
<?php } ?>
<?php } ?> 
