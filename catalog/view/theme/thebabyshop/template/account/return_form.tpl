      ...
      <div class="content">
        <div class="return-product">
          <div class="return-name"><span class="required">*</span> <b><?php echo $entry_product; ?></b><br />
            <input style="width:90%" type="text" name="product" value="<?php echo $product; ?>" />
            <br />
          ...
          <div class="return-model"><span class="required">*</span> <b><?php echo $entry_model; ?></b><br />
            <input style="width:90%" type="text" name="model" value="<?php echo $model; ?>" />
            <br />
            <?php if ($error_model) { ?>
          ...
          <div class="return-quantity"><b><?php echo $entry_quantity; ?></b><br />
            <input style="width:90%" type="text" name="quantity" value="<?php echo $quantity; ?>" />
          </div>
        </div>
