...
class ControllerCommonFooter extends Controller {
	protected function index() {
		...
		$this->data['thebabyshop_contacts_title'] = $this->config->get('thebabyshop_contacts_title' . $this->config->get('config_language_id'));
		...
		$this->data['thebabyshop_twitter_block_title'] = $this->config->get('thebabyshop_twitter_block_title' . $this->config->get('config_language_id'));
		$this->data['thebabyshop_custom_title'] = $this->config->get('thebabyshop_custom_title' . $this->config->get('config_language_id'));
		$this->data['thebabyshop_custom_content'] = $this->config->get('thebabyshop_custom_content' . $this->config->get('config_language_id'));
		$this->data['thebabyshop_powered_content'] = $this->config->get('thebabyshop_powered_content' . $this->config->get('config_language_id'));
		$this->data['thebabyshop_about_content'] = $this->config->get('thebabyshop_about_content' . $this->config->get('config_language_id'));
