...
class ControllerCheckoutPaymentAddress extends Controller {
	public function index() {
		...
		$this->data['text_checkout_changeshipping'] = $this->language->get('text_checkout_changeshipping');
		$this->data['text_checkout_payment_method2'] = $this->language->get('text_checkout_payment_method2');		
		$this->data['text_checkout_confirm2'] = $this->language->get('text_checkout_confirm2');
		$this->data['text_checkout_changeshipping'] = $this->language->get('text_checkout_changeshipping');
		...
		if(isset($this->session->data['changeshipping'])){
			$this->data['changeshipping'] = $this->session->data['changeshipping'];
		}else{
			$this->data['changeshipping'] = 'T';
		}
	...
	public function validate() {
		...
		if (!$json) {
			$this->session->data['changeshipping'] = $this->request->post['changeshipping'];
			if (isset($this->request->post['payment_address']) && $this->request->post['payment_address'] == 'existing') {
				...
				if (!$json) {			
					...
					if($this->request->post['changeshipping']=='T'){
				...
				if (!$json) {
					// Default Payment Address
					$this->load->model('account/address');
					$n_address_id = $this->model_account_address->addAddress($this->request->post);

					$this->session->data['payment_address_id'] = $n_address_id;
					$this->session->data['payment_country_id'] = $this->request->post['country_id'];
					$this->session->data['payment_zone_id'] = $this->request->post['zone_id'];


					if($this->request->post['changeshipping']=='T'){
						$this->session->data['shipping_address_id'] = $n_address_id;
