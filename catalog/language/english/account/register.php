...
$_['text_your_details']    = 'Register with TheBabyShop.com';//'Your Personal Details';
$_['text_your_address']    = 'Your Address';
$_['text_newsletter']      = 'Newsletter';
$_['text_your_password']   = 'Your Password';
$_['text_agree']           = 'By clicking button below, you agree to the  <a class="colorbox" href="%s" alt="%s" style="font-size:10px;line-height:13px;color:#AAA;">%s</a> of The Baby Shop.';
...
$_['entry_password']       = 'Create Password:';
