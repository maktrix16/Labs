...
// Text
$_['text_success']           = '<h3>The item has been added to your shopping bag</h3><a href="%s"><img src="image/%s" class="img" /></a><div class="name">%s</div><div class="basket_price">%s</div><div class="call-to-action"><a href="index.php?route=checkout/cart" class="button">View Cart</a></div>';
...
// Entry
$_['entry_coupon']           = 'Promotional Code';
