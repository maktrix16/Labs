...
$_['text_coupon']            = '您已經成功使用優惠券！';
$_['text_voucher']           = '您已經成功使用禮品券！';
$_['text_reward']            = '您已經成功使用積分！';
$_['text_shipping']          = '您的預估運費已經成功使用！';
$_['text_login']             = '警告︰ 您必須<a href="%s">登錄</a> 或 <a href="%s">創建新賬戶</a> 後才能顯示單價！';
$_['text_points']            = '積分︰ %s';
$_['text_items']             = '%s 件商品';
$_['text_next']              = '下一步您想要做什麼？';
$_['text_next_choice']       = '選擇使用優惠券， 或獎勵積分， 或預估貨運成本';
$_['text_use_coupon']        = '使用優惠券';
$_['text_use_voucher']       = '使用禮品券';
$_['text_use_reward']        = '使用積分(有效積分 %s)';
$_['text_shipping_estimate'] = '運費 &amp; 稅費預估';
$_['text_shipping_detail']   = '請輸入您的貨運目的地獲取預估運費。';
$_['text_shipping_method']   = '請選擇您希望使用的貨運方式。';
$_['text_empty']             = '您的購物車內沒有商品！';
$_['text_weight']            = '商品重量︰';
$_['text_login']             = '注意︰ 請<a href="%s">登錄</a> 或 <a href="%s">註冊新賬號</a> 以便查看價格！';
$_['text_until_cancelled']   = '直到取消';
$_['text_recurring_item']    = '循環支付商品';
...
$_['entry_voucher']          = '請輸入您的禮品券︰';
$_['entry_reward']           = '使用積分 (Max %s)︰';
...
$_['error_shipping']         = '警告︰ 請選擇運輸方式！';
$_['error_no_shipping']      = '警告︰ 無有效運輸方式。請<a href="%s">聯絡我們</a>獲得幫助！';
$_['error_profile_required'] = '請選擇付款情況！';
