...
require_once DIR_SYSTEM . 'library/Mandrill/Templates.php';
require_once DIR_SYSTEM . 'library/Mandrill/Users.php';
require_once DIR_SYSTEM . 'library/Mandrill/Rejects.php';
require_once DIR_SYSTEM . 'library/Mandrill/Inbound.php';
require_once DIR_SYSTEM . 'library/Mandrill/Tags.php';
require_once DIR_SYSTEM . 'library/Mandrill/Messages.php';
require_once DIR_SYSTEM . 'library/Mandrill/Internal.php';
require_once DIR_SYSTEM . 'library/Mandrill/Urls.php';
require_once DIR_SYSTEM . 'library/Mandrill/Webhooks.php';
require_once DIR_SYSTEM . 'library/Mandrill/Senders.php';
require_once DIR_SYSTEM . 'library/Mandrill/Exceptions.php';
