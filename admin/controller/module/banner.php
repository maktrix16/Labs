...
class ControllerModuleBanner extends Controller {
	...
	public function index() {   
		...
		$this->data['text_column_right'] = $this->language->get('text_column_right');
                $this->data['text_home_banner_2'] = $this->language->get('text_home_banner_2');
                $this->data['text_home_banner_3'] = $this->language->get('text_home_banner_3');
                $this->data['text_home_banner_4'] = $this->language->get('text_home_banner_4');
                $this->data['text_home_banner_5'] = $this->language->get('text_home_banner_5');
