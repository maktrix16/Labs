          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><select name="banner_module[<?php echo $module_row; ?>][position]">
                  ...
                  <?php } ?>
                  <?php if ($module['position'] == 'home_banner_2') { ?>
                  <option value="home_banner_2" selected="selected"><?php echo $text_home_banner_2; ?></option>
                  <?php } else { ?>
                  <option value="home_banner_2"><?php echo $text_home_banner_2; ?></option>
                  <?php } ?>
                  <?php if ($module['position'] == 'home_banner_3') { ?>
                  <option value="home_banner_3" selected="selected"><?php echo $text_home_banner_3; ?></option>
                  <?php } else { ?>
                  <option value="home_banner_3"><?php echo $text_home_banner_3; ?></option>
                  <?php } ?>
                  <?php if ($module['position'] == 'home_banner_4') { ?>
                  <option value="home_banner_4" selected="selected"><?php echo $text_home_banner_4; ?></option>
                  <?php } else { ?>
                  <option value="home_banner_4"><?php echo $text_home_banner_4; ?></option>
                  <?php } ?>
                  <?php if ($module['position'] == 'home_banner_5') { ?>
                  <option value="home_banner_5" selected="selected"><?php echo $text_home_banner_5; ?></option>
                  <?php } else { ?>
                  <option value="home_banner_5"><?php echo $text_home_banner_5; ?></option>
                  <?php } ?>
...
function addModule() {	
	...
	html += '      <option value="column_right"><?php echo $text_column_right; ?></option>';
        html += '      <option value="home_banner_2"><?php echo $text_home_banner_2; ?></option>';
        html += '      <option value="home_banner_3"><?php echo $text_home_banner_3; ?></option>';
        html += '      <option value="home_banner_4"><?php echo $text_home_banner_4; ?></option>';
        html += '      <option value="home_banner_5"><?php echo $text_home_banner_5; ?></option>';
	html += '    </select></td>';
