...
<div id="tab-facebooklogin_<?php echo $store['store_id']; ?>">
    <table class="form wideBoxes">
        ...
        <td>
          <div class="buttonPreview">
              <div class="box box-fbconnect">
                <div class="box-heading"><?php echo !empty($data['FacebookLogin'][$store['store_id']]['WrapperTitle_'.$firstLanguageCode]) ? $data['FacebookLogin'][$store['store_id']]['WrapperTitle_'.$firstLanguageCode] : ''; ?></div>
                <div class="box-content">
                  <a href="javascript:void(0)" class="facebookLoginAnchor <?php echo !empty($data['FacebookLogin'][$store['store_id']]['ButtonDesign']) ? $data['FacebookLogin'][$store['store_id']]['ButtonDesign'] : ''; ?>"><span class="fbSpan"></span><span class="fbTitle"><?php echo !empty($data['FacebookLogin'][$store['store_id']]['ButtonName_'.$firstLanguageCode]) ? $data['FacebookLogin'][$store['store_id']]['ButtonName_'.$firstLanguageCode] : ''; ?></span></a>
                </div>
              </div>
          </div>
        </td>
      ...
      <tr class="hideableRow fbWrapperTitle" <?php echo(!empty($data['FacebookLogin'][$store['store_id']]['WrapIntoWidget']) && $data['FacebookLogin'][$store['store_id']]['WrapIntoWidget'] == 'Yes') ? '' : 'style="display:none"' ; ?>>
	...
	$(document).ready(function() {
		...
		$('#tab-facebooklogin_<?php echo $store['store_id']; ?> .buttonNameTextboxes input').keyup(function() {
			$('#tab-facebooklogin_<?php echo $store['store_id']; ?> .buttonPreview span.fbTitle').html($(this).val());
		}).focus(function() {
			$(this).trigger('keyup');	
		});
		...
		$('#tab-facebooklogin_<?php echo $store['store_id']; ?> .FacebookWrapIntoWidget').change(function() {
			if ($(this).val() == 'Yes') {
				$('#tab-facebooklogin_<?php echo $store['store_id']; ?> .fbWrapperTitle').show();
			} else {
				$('#tab-facebooklogin_<?php echo $store['store_id']; ?> .fbWrapperTitle').hide();
			}
		}).trigger('change');
