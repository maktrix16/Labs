...
define('baPRODUCT',$this->request->get['product_id']);
		...
		if ($product_info) {
			...
			$this->data['thebabyshop_product_custom_content'] = $this->config->get('thebabyshop_product_custom_content' . $this->config->get('config_language_id'));	
			$this->data['thebabyshop_product_custom_tab_title'] = $this->config->get('thebabyshop_product_custom_tab_title' . $this->config->get('config_language_id'));		
			$this->data['thebabyshop_product_custom_tab_content'] = $this->config->get('thebabyshop_product_custom_tab_content' . $this->config->get('config_language_id'));
			$this->data['thebabyshop_product_custom_tab_2_title'] = $this->config->get('thebabyshop_product_custom_tab_2_title' . $this->config->get('config_language_id'));		
			$this->data['thebabyshop_product_custom_tab_2_content'] = $this->config->get('thebabyshop_product_custom_tab_2_content' . $this->config->get('config_language_id'));
			$this->data['thebabyshop_product_custom_tab_3_title'] = $this->config->get('thebabyshop_product_custom_tab_3_title' . $this->config->get('config_language_id'));		
			$this->data['thebabyshop_product_custom_tab_3_content'] = $this->config->get('thebabyshop_product_custom_tab_3_content' . $this->config->get('config_language_id'));			
			...
			$this->data['tab_related'] = $this->language->get('tab_related');
                        $this->data['tab_brand_story'] = $this->language->get('tab_brand_story');
			...
			$this->data['points'] = $product_info['points'];
				...
				$manufacturer = $this->model_catalog_manufacturer->getManufacturerDesc($product_info['manufacturer_id']);
				if($manufacturer){
					$this->data['manufacturer_desc'] = html_entity_decode($manufacturer['description'], ENT_QUOTES, 'UTF-8');
				}
			}else{
