<?php echo $header; ?>
<div class="all-white">
<div class="span15"><div class="row-fluid"><?php echo $content_top; ?>
  <?php if ($products) { ?>
  ...
  <div class="product-grid" id="el-s">
	<?php $counter = 0; foreach ($products as $product) { 
	   if (($counter+3) %3 == 0) $xclass="";
	   else $xclass=""; ?>        
    <div<?php echo ' id="p' . $product['product_id'] . '"'; ?> class="span">
  ...
  <?php } else { ?>
  <div class="content search_results"><?php echo $text_empty; ?><?php echo $search; ?></div>
  <?php }?>
