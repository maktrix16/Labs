...
class ModelCatalogManufacturer extends Model {
	...
	public function getManufacturerDesc($manufacturer_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "manufacturer_description m WHERE m.language_id = '" . (int)$this->config->get('config_language_id') . "' AND  m.manufacturer_id = '" . (int)$manufacturer_id ."'");
